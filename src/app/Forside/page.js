  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative w-full">
        ...
        />
        <h1
          className="absolute md:top-1/2 xs:top-10 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white
 lg:text-7xl xs:text-2xl  md:text-6xl font-bold text-nowrap"
        >
          ANKJÆR TOTALENTREPRISE
        </h1>
        <p className="absolute md:top-2/3 xs:top-20 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white xs:text-l md:text-2xl xs:text-nowrap">
