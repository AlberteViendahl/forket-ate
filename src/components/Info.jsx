const Info = () => {
    return (
      <div className="flex flex-col gap-6 px-4 pt-4 pb-4 sm:px-8 md:px-16 lg:px-24 max-w-4xl mx-auto my-10 bg-white rounded-15">
        ...
        <img src="/img/martinVinker.jpeg" alt="Martin Ankjær" className="h-[200px] w-[300px] rounded-12"/>

        <h2 className="text-xl font-semibold">
          Et hus er mere end bare mursten – det er en drøm, der skal bygges fra bunden.
        </h2>
        ...
        <h3 className="font-bold text-lg">Kvalitet. Troværdighed. Personlighed.</h3>
        ...
        <img src="/img/vedbaekHus.jpeg" alt="vedbæk hus" className="h-[200px] w-[300px] rounded-12"/>
