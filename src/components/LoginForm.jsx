  ...
  return (
    <div className="fixed inset-0 backdrop-blur-lg flex justify-center items-center z-50">
      <form
        ...
        className="relative flex flex-col text-brown p-5 w-[300px] rounded-15 bg-lightblue border"
      >
        ...
        <button type="submit" className='bg-darkblue text-white px-4 mb-2 rounded-10 h-[40px]'>Login</button>
